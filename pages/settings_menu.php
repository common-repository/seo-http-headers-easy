...
?>
<div class="wrap">
    <h2 class="head-name-pl-avk"><span class="dashicons dashicons-hammer dashicons-http"></span>&nbsp;<?php _e('HTTP 1.1 headers', self::slug); ?></h2>
    ...
    <div class="support-avkproject">
        <p><span class="dashicons dashicons-admin-generic"></span>&nbsp;<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=KA8HCWVUUVEK4"><?php _e('Order help on plugin installation and setting', self::slug); ?></a></p>
    </div>
